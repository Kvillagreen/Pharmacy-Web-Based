...
class MethodMedicineRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'is_yakap_eligible' => ['required', 'boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'is_yakap_eligible.required' => 'Yakap Eligible Medicine is required.',
            ...
            'is_yakap_eligible.boolean' => 'Yakap Eligible Medicine must be true or false.',
